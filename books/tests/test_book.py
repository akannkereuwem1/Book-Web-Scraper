#This unit test confirms that each call to .parse()
#identifies the right elements from the HTML, fetches all books, and 
#creates a new request for the pagination URL
...
"""
    ...
    def test_parse_creates_pagination_request(self):
        """Test if the spider creates a pagination request"""
        pass
